...
//    glLineWidth(3);
//    glDrawElements(GL_LINES,ind_size/2,GL_UNSIGNED_INT,ind_clear);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
     ...
     * @param v3 - чистый вектор индексов нод.
     */
    ...
    while (!bQuit) {
        ...
        if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
            ...
            Player_Move();
            ShowWorld(vert, ind, ppp, ind_size, vert_size, tex_coord, vertex, baseInd, ind_clear);
